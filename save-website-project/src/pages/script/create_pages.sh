...
<head>
    ...
    <title>PAGE_TITLE - Website Template</title>
...
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="patient.html">Patient Office</a></li>
            </ul>
        </nav>
    </header>
    ...
    <footer>
        <nav>
            <ul>
                <li><a href="gtc.html">GTC</a></li>
                <li><a href="impressum.html">Impressum</a></li>
                <li><a href="createDisplay.html">Create Display</a></li>
